...
@Injectable() // concern
export class CatService extends AnimalService implements IAnimal {
  constructor() {
    super();
  }
  async getAllBreeds(): Promise<Array<Animal>> {
    const url = `${animalConfig.host1}/breeds`;
  ...
  async getBreedById(params: getBreedByIdParams): Promise<Animal> {
    const url = `${animalConfig.host1}/breeds/${params.breedId}`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
  ...
  async searchBreedByName(
    ...
    const url = `${animalConfig.host1}/breeds/search`;
    const headers = animalConfig.config;
  ...
  async listCategories(): Promise<Array<Categories>> {
    const url = `${animalConfig.host1}/categories`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
  ...
  async listVotes(): Promise<Array<Vote>> {
    const url = `${animalConfig.host1}/votes`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
  ...
  async getSpecificVote(params: getSpecificVoteParams): Promise<Vote> {
    const url = `${animalConfig.host1}/votes/${params.voteId}`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
  ...
  async listFavourites(): Promise<Array<Favourite>> {
    const url = `${animalConfig.host1}/favourites`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
  ...
  async getFavourite(params: getFavouriteParams): Promise<Favourite> {
    const url = `${animalConfig.host1}/favourites/${params.favouriteId}`;
    const headers = animalConfig.config;
    const response = await axios.get(url, { headers });
    const status = response.status;
    const data = response.data;
